...
std::tuple<int, Point<T>, Point<T>> segmentIntersection(Line<T> l1, Line<T> l2) {
    ...
    if (cross(l1.b - l1.a, l2.b - l2.a) == 0) {
        if (cross(l1.b - l1.a, l2.a - l1.a) != 0) {
            ...
            int maxx1 = std::max(l1.a.x, l1.b.x);
            int minx1 = std::min(l1.a.x, l1.b.x);
            int maxy1 = std::max(l1.a.y, l1.b.y);
            int miny1 = std::min(l1.a.y, l1.b.y);
            int maxx2 = std::max(l2.a.x, l2.b.x);
            int minx2 = std::min(l2.a.x, l2.b.x);
            int maxy2 = std::max(l2.a.y, l2.b.y);
            int miny2 = std::min(l2.a.y, l2.b.y);
